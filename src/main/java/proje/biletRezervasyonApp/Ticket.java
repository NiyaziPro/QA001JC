...
public class Ticket {
    ...
    public void getTotalPrice(int age) {
        ...
        if (age < 13) {
            toplam = toplam / 2;
            System.out.println("12 yas alti indirimli total tutar : " + toplam);
        } else if (age > 64) {
            toplam = toplam / 0.7;
            System.out.println("65 yas ustu indirimli total tutar : " + toplam);
        }
        this.price = toplam;
    }
    ...
    public void printTicket(Bus otobus) {
        ...
        System.out.println("Yolculuk Tipi  : " + (this.typeNo == 1 ? "Tek Tön" : "Gidiş-Dönüş"));
